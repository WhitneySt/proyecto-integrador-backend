...
public class Transaccion {
    ...
    public Transaccion(Integer id, Date fechaTransaccion, Double monto, String descripcion, Integer idTipoTransaccion, Integer idCuentaOrigen, Integer idCuentaDestino, Integer idBolsilloOrigen, Integer idBolsilloDestino, Integer idTipoMovimiento) {
        this.id = id;
